...
--CHAR : 고점 문자
--VARCHAR2 : 가변문자
--NCHAR, NVARCHAR : National (다국어, 영어가 아닌 한국어/일본어/중국어/...각나라별 언어 설정)
--DATE : (시간)날짜 va TIMEZONE, TUMESTAMP : 밀리세컨드까지 저장
--LOB(Large object), CLOB, BLOB : 이미지, 영상등의 용량이 큰 바이너리 파일들을 관리하는 타임
...
INSERT TNTO intem itonTBL 
VALUES (0001, 1, '따근한 군고구마 1박스', 100, 15000, TO_DATE('2022/10/15','RRRR/MM/DD HH:MT:SS'));
